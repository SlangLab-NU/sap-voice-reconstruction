# Adapted from SlangLab-NU/VallE @ e65a69b (valle/modules/scaling.py), refactor by
# A. Mohan & J. Lewis. Pure-PyTorch transformer backbone shared by VTN (Phase 1)
# and VALL-E (Phase 2). No ESPnet. Only local change: see NOTE where present.
...
from .utils import Transpose  # NOTE: was 'from valle.utils import Transpose' (dropped icefall dep)
